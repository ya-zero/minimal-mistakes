...
в моем  случае я забрал не все адреса, а только часть изменив iptables -t nat -R PREROUTING  47 -to-source 91.197.0.0-91.197.76.0.63     --persistent  так как на стороне BRAS еще не все готово. 

3) на bras создать sub интерфейсы.  
eth0.2000:1  91.197.76.0.1
eth0.2000:2  91.197.76.0.2
eth0.2000:3  91.197.76.0.3
и так далее. 

4) занатить через iptables -t nat -A POSTROUTING -s 10.1.0.0/19 -o ens6f1.14 -j SNAT --to-source 91.197.0.64-91.197.76.0.127     --persistent
