...
производительносит сетевой карты (буфера, очередей, распределения прерывайни и т.д.)
...
#### <h3> 3)  изменение параметров через ethtool.  </h3>
...
#### <h3> 4)  Некоторые сетевые карты и их драйверы поддерживают </h3>
...
```
#### <h3> 5)  количесвто очередей.    можно настривать разными способами.  </h3>
...
#### <h3> 6) распределение прерыванйи между ядрами  , </h3>
