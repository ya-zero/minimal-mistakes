...
в моем  случае я забрал не все адреса, а только часть изменив iptables -t nat -R PREROUTING  47 -to-source 91.197.0.0-91.197.0.0.63     --persistent  так как на стороне BRAS еще не все готово. 
